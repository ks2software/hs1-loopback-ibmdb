...
IBMDB.prototype.setConnectionProperties = function(name, settings) {
  ...
  self.connectionOptions.connectionTimeout = parseInt(settings.connectionTimeout, 10) || 60;
  self.connectionOptions.idleTimeout = parseInt(settings.idleTimeout, 10) || 600;
  self.connectionOptions.autoCleanIdle = settings.autoCleanIdle || false;
